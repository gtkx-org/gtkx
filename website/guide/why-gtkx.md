...
Convinced? The [tutorial](/guide/) builds a complete GNOME Tasks app from scaffolding to Flathub submission, or you can jump straight to [Getting Started](/guide/getting-started) and scaffold an app of your own.
