...
- CSS-in-JS styling, React Spring animations, React Navigation stack, tab, and drawer navigators, high-level list and grid components, and dialogs that present on mount,
