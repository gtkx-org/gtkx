...
Deleting here currently moves the task to Trash while leaving its editor open. [Deleting Without Fear](/v2/tutorial/trash-and-toasts) will add undo and confirmation behavior and close that page.
...
Continue to [Menus, Accelerators, and Shortcuts](/v2/tutorial/actions-menus-shortcuts).
