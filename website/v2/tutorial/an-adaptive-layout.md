...
Your app shows a sidebar of lists beside the tasks for the selected one, built in [Lists and a Sidebar](/v2/tutorial/lists-and-the-sidebar).
...
One field and its setter is a thin slice, and it stays that way for now. [Smart Views, Filters, and Search](/v2/tutorial/smart-views-and-search) adds the header filter and the search state to it, and [Menus, Accelerators, and Shortcuts](/v2/tutorial/actions-menus-shortcuts) adds which dialog is showing.
...
This is the reverse of the controlled-widget pairing you wrote for the completion checkbox in [Completing, Starring, and Deleting](/v2/tutorial/completing-and-deleting). There the widget owned a fact you also kept, so the value prop needed the matching notify signal beside it. Here a single owner holds both halves, so there is no second copy to keep in agreement and nothing for you to catch.
...
`contentPlaceholder` is what fills it, and `AdwStatusPage` is the empty state that filled the whole window in [Your First Window](/v2/tutorial/your-first-window): an icon, a title, and a line of explanation, centered in whatever space it is given.
...
The wording looks one chapter ahead: [Smart Views, Filters, and Search](/v2/tutorial/smart-views-and-search) puts All Tasks, Today, Important, and Trash in the sidebar beside your lists, and any of them can be what fills the pane.
...
[Smart Views, Filters, and Search](/v2/tutorial/smart-views-and-search) derives All Tasks, Today, Important, and Trash from the tasks you already have.
