...
project needs a generator with `--pnpm-store-version`. Explicit pnpm pins support major versions 10 and 11
(11.3.0 or later), and the `packageManager` field must include an integrity digest.
