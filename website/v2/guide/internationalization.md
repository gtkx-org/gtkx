...
Install `@gtkx/i18n@beta` and make the GNU gettext command-line tools available in your development environment.
...
See [Deploying](/v2/guide/deploying) for the packaging workflow.
