...
const drawTextMask = (self: Gtk.DrawingArea, cr: Context, width: number, height: number) => {
    cr.save();
    const layout = self.createPangoLayout("");
...
function TextmaskDemo() {
    return (
        <GtkDrawingArea
            ...
            accessibleLabel="Pango power"
            drawFunc={drawTextMask}
        />
    );
}
