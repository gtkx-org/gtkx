...
const ImageDemo = () => {
    return (
        <Box orientation={Gtk.Orientation.VERTICAL} spacing={20} marginStart={20} marginEnd={20} marginTop={20}>
            <Label label="Image" cssClasses={["title-2"]} halign={Gtk.Align.START} />

            <Box orientation={Gtk.Orientation.VERTICAL} spacing={12}>
                <Label label="About Image Widget" cssClasses={["heading"]} halign={Gtk.Align.START} />
                <Label
            ...
            <Box orientation={Gtk.Orientation.VERTICAL} spacing={12}>
                <Label label="From Icon Names" cssClasses={["heading"]} halign={Gtk.Align.START} />
                <Label
                ...
                <Box orientation={Gtk.Orientation.HORIZONTAL} spacing={24} halign={Gtk.Align.CENTER}>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        ...
                        <Label label="document-open" cssClasses={["dim-label", "caption"]} />
                    </Box>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="document-save-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="document-save" cssClasses={["dim-label", "caption"]} />
                    </Box>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="edit-copy-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="edit-copy" cssClasses={["dim-label", "caption"]} />
                    </Box>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="edit-delete-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="edit-delete" cssClasses={["dim-label", "caption"]} />
                    </Box>
                </Box>
            </Box>

            <Box orientation={Gtk.Orientation.VERTICAL} spacing={12}>
                <Label label="Common Action Icons" cssClasses={["heading"]} halign={Gtk.Align.START} />
                <Box orientation={Gtk.Orientation.HORIZONTAL} spacing={24} halign={Gtk.Align.CENTER}>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="list-add-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="list-add" cssClasses={["dim-label", "caption"]} />
                    </Box>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="list-remove-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="list-remove" cssClasses={["dim-label", "caption"]} />
                    </Box>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="go-previous-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="go-previous" cssClasses={["dim-label", "caption"]} />
                    </Box>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="go-next-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="go-next" cssClasses={["dim-label", "caption"]} />
                    </Box>
                </Box>
            </Box>

            <Box orientation={Gtk.Orientation.VERTICAL} spacing={12}>
                <Label label="Status Icons" cssClasses={["heading"]} halign={Gtk.Align.START} />
                <Box orientation={Gtk.Orientation.HORIZONTAL} spacing={24} halign={Gtk.Align.CENTER}>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="dialog-information-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="info" cssClasses={["dim-label", "caption"]} />
                    </Box>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="dialog-warning-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="warning" cssClasses={["dim-label", "caption"]} />
                    </Box>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="dialog-error-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="error" cssClasses={["dim-label", "caption"]} />
                    </Box>
                    <Box orientation={Gtk.Orientation.VERTICAL} spacing={8} halign={Gtk.Align.CENTER}>
                        <Image iconName="emblem-ok-symbolic" iconSize={Gtk.IconSize.LARGE} />
                        <Label label="ok" cssClasses={["dim-label", "caption"]} />
                    </Box>
                </Box>
            </Box>
        </Box>
