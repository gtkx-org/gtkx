...
const LinkButtonDemo = () => {
    return (
        <Box orientation={Gtk.Orientation.VERTICAL} spacing={20} marginStart={20} marginEnd={20} marginTop={20}>
            <Label label="Link Buttons" cssClasses={["title-2"]} halign={Gtk.Align.START} />

            <Box orientation={Gtk.Orientation.VERTICAL} spacing={12}>
                <Label label="External Links" cssClasses={["heading"]} halign={Gtk.Align.START} />
            ...
            <Box orientation={Gtk.Orientation.VERTICAL} spacing={12}>
                <Label label="URI as Label" cssClasses={["heading"]} halign={Gtk.Align.START} />
