...
/**
 * The import specifier `@gtkx/react` reads its metadata tables from and app
 * code imports its resolved-config constants from. Served by the gtkx Vite
 * plugins during `gtkx dev`/`gtkx build` and by the `@gtkx/vitest` plugin under
 * tests; `gtkx build` inlines the resolved module into the production bundle.
 */
 ...
 * field of the project's resolved `gtkx.config.ts` as a named constant that
 * `@gtkx/react` and app code import.
 *
