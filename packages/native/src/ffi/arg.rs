...
use crate::ffi::{descriptors::Descriptor, value::Value};
...
impl Arg {
    ...
    pub fn from_js_array(env: &Env, value: &Array) -> napi::Result<Vec<Self>> {
        crate::ffi::value::map_js_array(env, value, Self::from_js_value)
    }
    ...
    pub fn from_js_value(env: &Env, value: Unknown<'_>) -> napi::Result<Self> {
        ...
        let ty = Descriptor::from_descriptor(env, type_prop)?;
