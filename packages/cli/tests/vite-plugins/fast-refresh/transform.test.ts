...
import { gtkxSwcSsrRefresh } from "../../../src/vite-plugins/fast-refresh/transform.js";
...
const getTransform = (plugin: ReturnType<typeof gtkxSwcSsrRefresh>): TransformFn => {
