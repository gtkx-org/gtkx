...
const paths: DeployPaths = {
    root: ROOT,
    dist: `${ROOT}/dist`,
    outDir: `${ROOT}/build/deploy`,
    metadata: `${ROOT}/build/deploy/metadata`,
    runtime: `${ROOT}/build/deploy/runtime`,
    stage: `${ROOT}/build/deploy/stage`,
    overlay: `${ROOT}/build/deploy/overlay`,
    targets: `${ROOT}/build/deploy/targets`,
    output: `${ROOT}/build/deploy/out`,
    dataDir: "data",
