...
declare module "../base.js" {
    ...
    namespace FontFace {
        ...
        function createForFtFace(face: ExternalObject<Handle>, loadFlags: number): FtFontFace;
        function createForPattern(pattern: ExternalObject<Handle>): FtFontFace;
    }
}
...
type FontFaceStatic = {
    ...
    createForFtFace(face: ExternalObject<Handle>, loadFlags: number): FtFontFace;
    createForPattern(pattern: ExternalObject<Handle>): FtFontFace;
};
...
FontFaceWithStatics.createForFtFace = (face: ExternalObject<Handle>, loadFlags: number): FtFontFace => {
...
FontFaceWithStatics.createForPattern = (pattern: ExternalObject<Handle>): FtFontFace => {
