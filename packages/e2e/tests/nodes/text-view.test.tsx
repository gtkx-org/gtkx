...
import { GtkButton, GtkTextAnchor, GtkTextTag, GtkTextView } from "@gtkx/jsx/gtk";
            ...
            function App({ showTag }: { showTag: boolean }) {
                return (
                    <GtkTextView ref={ref}>
                        Start
                        {showTag && (
                            <GtkTextTag name="dynamic" foreground="green">
                                New
                            </GtkTextTag>
                        )}
                        End
            ...
            function App({ showTag }: { showTag: boolean }) {
                return (
                    <GtkTextView ref={ref}>
                        Start
                        {showTag && (
                            <GtkTextTag name="removable" foreground="green">
                                Remove
                            </GtkTextTag>
                        )}
                        End
