...
export type PropertyNameOf<T extends GObject.Object> = keyof PropertiesOf<T> & keyof T;
 ...
 */
export function useProperty<T extends GObject.Object, P extends PropertyNameOf<T>>(
    object: RefProp<T>,
