...
import type { BackingInstanceClass, ContainerInfo, Props } from "./types.js";
...
export class Node<TBackingInstance = any, TProps = any, TParent extends Node = any, TChild extends Node = any> {
    ...
    constructor(typeName: string, props: TProps, backingInstance: TBackingInstance, rootContainer: ContainerInfo) {
