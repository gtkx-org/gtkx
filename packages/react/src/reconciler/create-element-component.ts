...
import { CONTAINER_PROP_KIND, LAZY_ELEMENT_KIND, OBJECT_PROP_KIND, WRAPPER_NODE_ELEMENT } from "./wrapper-kinds.js";
...
export const createElementComponent = <P extends object>(elementName: string): ((props: P) => ReactNode) => {
    const containerPropNames = collectContainerPropNames(elementName);
