 ...
 */
export const GtkxEnvModuleHeader: string = `/**
 ...
 * {@link GtkxEnvModuleHeader} with a trailing newline. Used to seed a freshly
 * scaffolded project so its `gtkx-env.d.ts` reference resolves before the first
 * codegen run.
 */
export const renderEmptyGtkxEnvModule = (): string => `${GtkxEnvModuleHeader}\n`;
