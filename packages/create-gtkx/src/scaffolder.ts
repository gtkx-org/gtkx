 ...
 * module that declares a project's GSettings schema types. The scaffolder writes
 * this header on its own to seed an initial, schema-free env module.
 */
...
const scaffoldProject = (root: string, resolved: ResolvedOptions): void => {
    ...
    for (const template of listTemplates()) {
        ...
        const destination = join(root, destinationFor(template));
